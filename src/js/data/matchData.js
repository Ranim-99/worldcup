...
// Results path (processInitialState) is unused in the 2026 predictor, but it
// still imports this. Empty stub keeps the build happy.
...
export const advance = [
  ...
  // [6] dummy for the third-place round (match 103 is special-cased; unused).
  /* { round: 'Match for third place', matches: [{ from: 103, num: 103, index: 0 }] }, */
